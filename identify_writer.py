...
from image_segmentation import line_segmentation, word_segmentation
...
for test_case in test_cases:
    ...
    for image_path in np.append(train_images_paths, test_image_path):
        ...
        if image_path == test_image_path:
            np.append(test_image_features, feature_vector)
        else:
            np.append(train_images_features, feature_vector)
