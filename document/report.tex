...
\begin{document}
    ...
    \input{sections/pipelineSummary.tex}
    \input{sections/preprocessing.tex}
    \input{sections/featureExtraction.tex}
    \input{sections/classification.tex}
    \input{sections/performanceAnalysis.tex}
    \input{sections/performanceEnhancements.tex}
    \input{sections/unsuccessfulTrials.tex}
    \input{sections/futureWork.tex}
    \input{sections/workDistribution.tex}
